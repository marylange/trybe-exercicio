...
if (nota1 >= 80) {
  console.log("Sua nota foi: "+ nota1 + "." + " Parabéns, você foi aprovada(o)!");
} 
else if (nota1 >= 60) {
  console.log("Sua nota foi: " + nota1 + "." + " Você está na nossa lista de espera.");
}
else {
  console.log("Sua nota foi: "+nota1+"."+" Você foi reprovada(o).");
}
