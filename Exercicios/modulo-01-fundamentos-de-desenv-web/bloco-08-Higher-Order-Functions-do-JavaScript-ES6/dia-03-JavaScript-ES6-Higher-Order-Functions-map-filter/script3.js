...
/* Testar como o map pode funcionar com outras HOFs */
...
// usando for
// const nomeCompletoDosDiurnos = (array) => {
//   const listaDosAlunosDiurnos = [];
//   for(let indice = 0; indice < array.length; indice += 1) {
//     if(array[indice].turno === 'Manhã'){
//       listaDosAlunosDiurnos.push(`Nome: ${array[indice].nome} ${array[indice].sobrenome}`);
//     }
//   }
//   return listaDosAlunosDiurnos;
// };
// nomeCompletoDosDiurnos(estudantes);

// // usando map e filter

// const alunosDaManha = estudantes.filter((aluno) => (aluno.turno === 'Manhã')).map((aluno) => `Nome: ${aluno.nome} ${aluno.sobrenome}`);
// console.log(alunosDaManha);
